...
import com.avd.R
import com.avd.databinding.FragmentSettingsDownloadsBinding
...
@AndroidEntryPoint
class SettingsFragmentDownloader : BaseFragment() {

    companion object {
        fun newInstance() = SettingsFragmentDownloader()
    }
    ...
    private lateinit var dataBinding: FragmentSettingsDownloadsBinding
...
//        val color = getThemeBackgroundColor()
        ...
        dataBinding = FragmentSettingsDownloadsBinding.inflate(inflater, container, false).apply {
//            this.settingsBackground.setBackgroundColor(color)
                    ...
                    if (isAdded) {
                        lifecycleScope.launch {
                            this@apply.adsTresholdText.text = getString(
                                R.string.ads_detection_treshold,
                                settingsViewModel?.videoDetectionTreshold?.get()?.toDouble()?.let {
    ...
    private fun ensureInitializedTexts() {
        ...
        if (videoDetectionTreshold != null) {
