...
import com.avd.R
import com.avd.databinding.FragmentNotificationDialogBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class NotificationDialogFragment : BottomSheetDialogFragment() {

    private var binding : FragmentNotificationDialogBinding?=null
    ...
    companion object {
        var notiCallbackfragment: NotificationCallback? = null
        fun registercallback(callback: NotificationCallback){
            notiCallbackfragment=callback
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mActivity?.let {
            binding?.btnEnable?.setOnClickListener {
                notiCallbackfragment?.onButtonClicked(true)
                dismiss()
            }
            binding?.btnLater?.setOnClickListener {
//                notiCallbackfragment?.onButtonClicked(false)
                dismiss()
            }
