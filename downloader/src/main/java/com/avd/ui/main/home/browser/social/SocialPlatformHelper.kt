...
enum class SocialPlatform(
    ...
    INSTAGRAM(
        ...
        step3TitleRes = R.string.social_step3_title,
        step3SubtitleRes = R.string.social_step3_subtitle,
        step1ImageRes = R.drawable.img_social_how_to_step1,
        step2ImageRes = R.drawable.img_social_how_to_step2,
        step3ImageRes = R.drawable.img_social_how_to_step3,
