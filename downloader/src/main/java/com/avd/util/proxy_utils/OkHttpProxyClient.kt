...
class OkHttpProxyClient @Inject constructor(
    ...
    private var currentProxy: com.avd.data.local.model.Proxy
    ...
    fun getProxyOkHttpClient(): OkHttpClient {
        ...
        if (proxy.host != currentProxy.host && proxy.port != currentProxy.port || (httpClientCached == null)) {
            ...
            httpClientCached = if (proxy == com.avd.data.local.model.Proxy.noProxy()) {
    ...
    private fun getProxy(): com.avd.data.local.model.Proxy {
